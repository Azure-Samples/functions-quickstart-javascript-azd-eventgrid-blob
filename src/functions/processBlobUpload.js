...
function getBlobServiceClient(context) {
...
async function processBlobUpload(blob, context) {
...
async function copyToProcessedContainerAsync(blobBuffer, blobName, context) {
